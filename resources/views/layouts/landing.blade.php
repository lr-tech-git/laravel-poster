...
<head>
    ...
    <link rel="stylesheet" href="/css/front-page-landing.css" />
        ...
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4 ">
            ...
            <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link fw-medium" aria-current="page" href="/#landingHero">{{ __('main.header-menu.main') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-medium" href="/#landingReviews">{{ __('main.header-menu.reviews') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-medium" href="/#landingFAQ">{{ __('main.header-menu.faq') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-medium" href="/#landingContact">{{ __('main.header-menu.contact_us') }}</a>
                    </li>
                </ul>
            </div>
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <!-- navbar button: Start -->
                <li>
                    <a href="/login" class="btn btn-primary" target="_blank"><span class="tf-icons bx bx-user me-md-1"></span><span class="d-none d-md-block">{{ __('main.header-menu.login_register') }}</span></a>
                </li>
                <!-- navbar button: End -->
            </ul>
            <!-- Toolbar: End -->
