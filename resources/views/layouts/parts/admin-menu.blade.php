<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme" style="touch-action: none; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
    ...
    <div class="app-brand demo ">
        <a href="/" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2"  style="text-transform:none">MyCity</span>
        </a>
    ...
    <ul class="menu-inner py-1 ps ps--active-y">
        ...
        <li class="menu-item {{ request()->routeIs('admin.complaints*') ? 'active' : '' }}">
            <a href="{{ route('admin.complaints.index') }}" class="menu-link">
                ...
                <div class="text-truncate" data-i18n="Complaint">Complaint</div>
            </a>
        </li>
        ...
        <div class="ps__rail-y" style="top: 0px; height: 369px; right: 4px;">
