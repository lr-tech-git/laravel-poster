    ...
    <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
            <div class="w-100 d-flex justify-content-center">
                <img src="/img/boy-with-rocket-light.png" class="img-fluid" alt="Login image" width="700" data-app-dark-img="illustrations/boy-with-rocket-dark.png" data-app-light-img="boy-with-rocket-light.png">
            </div>
        </div>
        <!-- /Left Text -->
            ...
            <div class="w-px-400 mx-auto">
                ...
                <div class="app-brand mb-5">
                    <a href="{{ route('home') }}" class="app-brand-link gap-2">
                        ...
                        <span class="app-brand-text demo text-body fw-bold" style="text-transform:none">{{ __('main.main_title') }}</span>
                    </a>
                </div>
                <!-- /Logo -->
                <h4 class="mb-2">Welcome to {{ __('main.name') }}! 👋</h4>
