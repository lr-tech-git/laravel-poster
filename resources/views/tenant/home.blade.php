...
@section('content')
    ...
    <section class="section-py first-section-pt help-center-header" style="margin-top:-75px;">
        <form action="{{ route('complaints.index') }}" method="GET">
            <h3 class="text-center"> {{ __('Announcement of the city') }} "{{ $tenant }}" </h3>
            <div class="input-wrapper my-3 input-group input-group-lg input-group-merge position-relative mx-auto">
                ...
                <input name="search" type="text" class="form-control" placeholder="{{ __('Search...') }}" aria-label="{{ __('Search') }}" aria-describedby="basic-addon1" />
            </div>
            <p class="text-center px-3 mb-0">{{ __('ASearch created ads: No lights, Not cleaned, Potholes in the road...') }}</p>
        </form>
    </section>
    ...
    <section class="section-py">
        <div class="container">
            <h3 class="text-center mb-4">{{ __('Top problematic topics') }}</h3>
            <div class="row">
                        ...
                        <div class="col-md-4 mb-md-0 mb-4">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="my-2">{{ __('Court') }}</h5>
                                    <p> {{ __('Uncleaned area, Parking on the sidewalk, Broken playground...') }}</p>
                                    <a class="btn btn-sm btn-label-primary" href="/category/1">{{ __('Show') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-md-0 mb-4">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="my-2">{{ __('Street') }}</h5>
                                    <p> {{ __('Improper driving of a car, a broken traffic sign, Potholes on the road...') }}</p>
                                    <a class="btn btn-sm btn-label-primary" href="/category/2">{{ __('Show') }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="my-2">{{ __('Public transport') }}</h5>
                                    <p> {{ __('Violation of schedule, Improper state of transport, Improper state of stop...') }}</p>
                                    <a class="btn btn-sm btn-label-primary" href="help-center-article.html">{{ __('Show') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="section-py bg-body">
        <div class="container">
            <h3 class="text-center mb-4">{{ __('Knowledge Base') }}</h3>
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled my-4">
                                        <li class="mb-2">
                                            <a href="help-center-article.html" class="text-body d-flex justify-content-between align-items-center">
