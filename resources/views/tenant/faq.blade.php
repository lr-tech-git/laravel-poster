...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y" style="margin-top:70px;">
        ...
        <div class="faq-header d-flex flex-column justify-content-center align-items-center">
            <h3 class="text-center"> {{ __("Hello, how can we help?") }} </h3>
            ...
            <p class="text-center mb-0 px-3">{{ __("or choose a category to quickly find the help you need") }}</p>
        </div>
                    ...
                    <ul class="nav nav-align-left nav-pills flex-column">
                        <li class="nav-item">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#payment">
                                ...
                                <span class="align-middle">{{ __("Payment") }}</span>
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#delivery">
                                <i class='bx bx-shopping-bag faq-nav-icon me-1'></i>
                                <span class="align-middle">{{ __("Delivery") }}</span>
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#cancellation">
                                <i class='bx bx-rotate-left faq-nav-icon me-1'></i>
                                <span class="align-middle">{{ __("Cancellation & Return") }}</span>
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#orders">
                                <i class='bx bx-cube faq-nav-icon me-1'></i>
                                <span class="align-middle">{{ __("My Orders") }}</span>
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#product">
                                <i class='bx bx-cog faq-nav-icon me-1'></i>
                                <span class="align-middle">{{ __("Product & Services") }}</span>
                            </button>
                        </li>
                    </ul>
                    <div class="d-none d-md-block">
                        <div class="mt-5">
                            <img src="/img/sitting-girl-with-laptop-light.png" class="img-fluid w-px-200" alt="FAQ Image" data-app-light-img="/sitting-girl-with-laptop-light.png" data-app-dark-img="/sitting-girl-with-laptop-dark.png">
                        </div>
                    </div>
                </div>
            </div>
